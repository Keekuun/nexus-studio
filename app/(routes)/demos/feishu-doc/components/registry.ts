...
const CustomStoryCard = Node.create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['div', mergeAttributes(HTMLAttributes, { 'data-type': 'story-card' }), 0]
    },
    addNodeView() {
...
const CustomShotTable = Node.create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['div', mergeAttributes(HTMLAttributes, { 'data-type': 'shot-table' })]
    },
    addNodeView() {
...
const CustomBriefCard = Node.create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['div', mergeAttributes(HTMLAttributes, { 'data-type': 'brief-card' })]
    },
    addNodeView() {
...
const CustomCreativePlanning = Node.create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['div', mergeAttributes(HTMLAttributes, { 'data-type': 'creative-planning' }), 0]
    },
    addNodeView() {
