  ...
  content: [
          ...
          content: [
            ...
            },
            {
              ...
              content: [
                {
                  type: "text",
                  text: "An organic construction of silver filaments in a white void that solidifies into body architecture on a cold, confident model.",
                },
              ],
            },
            {
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      attrs: { blockId: "creative-li-1" },
                      content: [
                        {
                          type: "text",
                          text: "Mascot walks along a sunny school path holding a slice of toast in its mouth.",
                        },
                      ],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      attrs: { blockId: "creative-li-2" },
                      content: [
                        {
                          type: "text",
                          text: "Mascot stops as a magical golden swirl of energy envelops its body in a bright flash.",
                        },
                      ],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      attrs: { blockId: "creative-li-3" },
                      content: [
                        {
                          type: "text",
                          text: "Sailor Moon Mascot strikes a signature heroic pose in front of a glowing crescent moon backdrop.",
                        },
                      ],
                    },
                  ],
          ...
          attrs: {
            ...
            images: [
              ...
              },
              {
                number: "04",
                title: "Night Style",
                src: "https://images.unsplash.com/photo-1575296093822-98cbf4f0353c",
              },
            ],
          },
          content: [
            ...
            },
            {
              ...
              content: [
                {
                  type: "text",
                  text: "A seamless transition from day to night, highlighting the versatility of the accessory collection.",
                },
              ],
            },
            {
              ...
              content: [
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      attrs: { blockId: "creative-li-4" },
                      content: [
                        {
                          type: "text",
                          text: "Office setting: Sharp focus on the bag's structure and practicality.",
                        },
                      ],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      attrs: { blockId: "creative-li-5" },
                      content: [
                        {
                          type: "text",
                          text: "Quick cut transition: The same bag styled for an evening event.",
                        },
                      ],
                    },
                  ],
                },
                {
                  ...
                  content: [
                    {
                      type: "paragraph",
                      attrs: { blockId: "creative-li-6" },
                      content: [
                        {
                          type: "text",
                          text: "Close-up on hardware details shimmering under city lights.",
                        },
                      ],
                    },
                  ],
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: 'This document outlines the core requirements for the new architecture. Hover over blocks to see the "Feishu-like" interaction.',
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: "This entire section is a container. Try hovering near the border of the grey box.",
            },
          ],
        },
        {
          ...
          content: [
            { type: "text", text: "The module should support hot-swapping." },
          ],
        },
      ],
    },
              ...
              content: [
                {
                  type: "paragraph",
                  attrs: { blockId: "li-1" },
                  content: [{ type: "text", text: "Latency < 50ms" }],
                },
              ],
            },
            {
              ...
              content: [
                {
                  type: "paragraph",
                  attrs: { blockId: "li-2" },
                  content: [{ type: "text", text: "Availability > 99.99%" }],
                },
              ],
            },
          ],
...
export function DocEditor({
  ...
  const [commentedRects, setCommentedRects] = useState<
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm sm:prose lg:prose-lg xl:prose-2xl mx-auto focus:outline-none max-w-none min-h-[500px]",
      },
    },
  });
  ...
  const handleMouseMove = useCallback((e: React.MouseEvent) => {
    ...
    for (const el of blockElements) {
      ...
      const isSection =
        element.getAttribute("data-type") === "section" ||
  ...
  return (
    ...
    >
      ...
      {commentedRects.map(({ id, rect }) => (
        <div
          key={id}
          className="pointer-events-none fixed z-0 border-b-2 border-yellow-500/60 bg-yellow-400/20 transition-all duration-300"
          style={{
            top: rect.top,
            left: rect.left,
            width: rect.width,
      ...
      {hoverRect && hoveredBlockId !== activeBlockId && (
        <div
          className="pointer-events-none fixed z-50 rounded border border-blue-400 bg-blue-400/5 transition-all duration-75 ease-out"
          style={{
            top: hoverRect.top,
            left: hoverRect.left,
        ...
        >
          ...
          <div className="absolute -left-[1px] -top-[1px] h-full w-1 bg-blue-400 opacity-50"></div>
        </div>
      )}
      ...
      {activeBlockId && clickRect && (
        <div
          className="pointer-events-none fixed z-50 rounded border-2 border-blue-600 bg-blue-600/5 shadow-sm transition-all duration-200"
          style={{
            top: clickRect.top,
            left: clickRect.left,
        ...
        >
          ...
          <div className="absolute right-0 top-0 h-full w-0.5 bg-blue-600 shadow-[0_0_10px_rgba(37,99,235,0.5)]"></div>
        </div>
      )}
    </div>
  );
